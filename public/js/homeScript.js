    ...
    function showPage(page) {
        ...
        for (let video in page) {
            ...
            $("#resultsAccordion").append(`
                <div id="${page[video].videoId}" class="bg-dark pt-3 accordion-item">

                    <h2 id="header-${page[video].videoId}" class="accordion-header">
                        <button
                            class="bg-dark bg-gradient text-white accordion-button collapsed d-flex"
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-${page[video].videoId}" 
                            aria-controls="collapse-${page[video].videoId}" 
                            aria-expanded="false">
                    ...
                    <div
                        id="collapse-${page[video].videoId}" 
                        class="bg-secondary accordion-collapse collapse"
                        aria-labelledby="header-${page[video].videoId}">
